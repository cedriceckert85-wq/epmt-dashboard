...
parser and evidence artifact. gates.evaluate_completion_gate consumes
exit codes/metrics that MUST originate from registry-executed commands.
"""
import yaml
from pathlib import Path

VALID_PARSERS={"exit_code","pytest_junit","metrics_json"}
VALID_REQUIRES={"none","gpu","windows","tailscale","riot_live","obs","network","real_stream"}
